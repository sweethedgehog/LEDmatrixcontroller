...
public class PerlinBackgroundActivity extends AppCompatActivity {
    ...
    private static EditText gridWidthView, gridHeightView, zScaleView, hueScaleView, hueOffsetView, saturationView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_perlin_background);

        if (!profilesNames.get(profilesNames.size() - 1).equals("Добавить")) profilesNames.add("Добавить");
        profileView = findViewById(R.id.perlin_profile_text_view);
        menuButton = findViewById(R.id.perlin_back_to_menu_button);
        profilesButton = findViewById(R.id.perlin_profile_select_button);
        deleteButton = findViewById(R.id.perlin_delete_button);
        micWindowView = findViewById(R.id.perlin_mic_window_plain_text);
        micTimeoutView = findViewById(R.id.perlin_mic_timeout_plain_text);
        pulseMinView = findViewById(R.id.perlin_mic_pulse_plain_text);
        speedView = findViewById(R.id.perlin_speed_plain_text);
        brightnessView = findViewById(R.id.perlin_brightness_plain_text);
        runJumpView = findViewById(R.id.perlin_run_jump_plain_text);
        maxFlashVew = findViewById(R.id.perlin_max_sat_flash_plain_text);
        reduceFlashView = findViewById(R.id.perlin_sat_flash_reduce_plain_text);
        maxBrightnessJumpView = findViewById(R.id.perlin_max_br_flash_plain_text);
        reduceBrightnessJumpView = findViewById(R.id.perlin_br_flash_reduce_plain_text);
        allowMicView = findViewById(R.id.perlin_allow_mic_switch);
        /////////////////////////////////////////////////////////////////////////////////////////
        gridWidthView = findViewById(R.id.perlin_grid_width_plain_text);
        gridHeightView = findViewById(R.id.perlin_grid_height_plain_text);
        zScaleView = findViewById(R.id.perlin_z_scale_plain_text);
        hueScaleView = findViewById(R.id.perlin_hue_scale_plain_text);
        hueOffsetView = findViewById(R.id.perlin_hue_offset_plain_text);
        saturationView = findViewById(R.id.perlin_saturation_plain_text);
    ...
    private void updateAll(){
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        gridWidthView.setText(String.valueOf(Objects.requireNonNull(profiles.get(currProfile))[11]));
        gridHeightView.setText(String.valueOf(Objects.requireNonNull(profiles.get(currProfile))[12]));
        zScaleView.setText(String.valueOf(Objects.requireNonNull(profiles.get(currProfile))[13]));
        hueScaleView.setText(String.valueOf(Objects.requireNonNull(profiles.get(currProfile))[14]));
        hueOffsetView.setText(String.valueOf(Objects.requireNonNull(profiles.get(currProfile))[15]));
        saturationView.setText(String.valueOf(Objects.requireNonNull(profiles.get(currProfile))[16]));
    }
    ...
    private void listenerInit(){
        micWindowView.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                if (keyEvent.getAction() == KeyEvent.ACTION_DOWN && i == KeyEvent.KEYCODE_ENTER){
                    ...
                    ProjectManager.hideKeyboard(PerlinBackgroundActivity.this, bufView);
                    return true;
                }
                return false;
            }
        ...
        menuButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PerlinBackgroundActivity.this, MenuActivity.class);
                PerlinBackgroundActivity.this.startActivity(intent);
                finish();
            }
        });
        profilesButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ProjectManager.showPopupMenu(PerlinBackgroundActivity.this, profilesButton,
                        profilesNames, new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                ...
                                if (profilesNames.get(i).equals("Добавить")){
                                    ProjectManager.showInputDialog(PerlinBackgroundActivity.this,
                                            "Введите имя нового профиля", new BluetoothFunc() {
                                                @Override
                                                public void run(String s) {
                                                    if (profilesNames.contains(s)){
                                                        Toast.makeText(PerlinBackgroundActivity.this,
                                                    ...
                                                    BluetoothManager.send(send);
                                                    Toast.makeText(PerlinBackgroundActivity.this, "Создан новый профиль \""
        ...
        gridWidthView.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                if (keyEvent.getAction() == KeyEvent.ACTION_DOWN && i == KeyEvent.KEYCODE_ENTER){
                    ...
                    int index = 11;
                    EditText bufView = gridWidthView;
        ...
        gridHeightView.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                if (keyEvent.getAction() == KeyEvent.ACTION_DOWN && i == KeyEvent.KEYCODE_ENTER){

                    int index = 12;
                    EditText bufView = gridHeightView;
        ...
        zScaleView.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                if (keyEvent.getAction() == KeyEvent.ACTION_DOWN && i == KeyEvent.KEYCODE_ENTER){

                    int index = 13;
                    EditText bufView = zScaleView;
